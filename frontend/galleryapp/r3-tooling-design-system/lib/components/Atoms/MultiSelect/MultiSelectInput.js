...
var MultiSelect = function (_a) {
    ...
    return (_jsx("div", __assign({ className: "input multiselect relative " + (disabled ? 'pointer-events-none' : '') }, { children: _jsxs("label", __assign({ htmlFor: multiSelectId, tabIndex: 0, "data-invalid": invalid, "data-modified": modified, className: "block min-h-12 w-full rounded-full py-3 px-6 outline-none border-2 text-sm uppercase " + (disabled
                ...
                : !value.size
                    ...
                    : 'border-medium-light-gray') }, { children: [_jsx(IconCustom, { icon: "ChevronDown", className: "input-icon absolute top-3 right-4 h-6 " + (disabled ? 'text-medium-light-gray-300' : 'text-dark-gray-300') }, void 0),
                _jsx("div", __assign({ className: "chips" }, { children: arrayChips }), void 0),
                _jsx("input", __assign({ "data-dropdown": true, className: "absolute top-4 outline-none text-transparent w-0 h-0", disabled: disabled, id: multiSelectId, required: required, type: "text", ref: multiSelectRef, defaultValue: Array.from(value).join(', '), onBlur: onBlur }, otherProps), void 0),
                _jsx("span", __assign({ className: "input-label absolute top-sm text-left left-6 bg-transparent font-bold text-sm uppercase tracking-smaller w-2/3 overflow-hidden whitespace-no-wrap " + (disabled
