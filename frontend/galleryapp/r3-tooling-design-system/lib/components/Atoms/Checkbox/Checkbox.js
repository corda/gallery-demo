...
var Checkbox = function (_a) {
    ...
    return (_jsx("div", __assign({ className: className }, { children: _jsxs("label", __assign({ className: "flex space-around relative p-2 select-none " + (disabled ? 'cursor-not-allowed' : 'cursor-pointer') + " " + (dropdown
                ? 'dropdown-item-checkbox py-4 border-b border-medium-light-gray-100'
                : ''), htmlFor: checkboxId }, { children: [_jsx("input", __assign({ className: "absolute opacity-0 h-0 w-0 " + (invalid ? 'invalid' : ''), type: "checkbox", value: value, id: checkboxId, ref: checkboxRef, checked: checked, disabled: disabled, onBlur: function () { return setModified(true); }, onChange: onChange }, otherProps), void 0),
                _jsx("span", { className: "checkmark h-5 w-5 min-w-5 border-2 rounded border-dark-gray-300 " + (dark ? 'bg-light-gray' : 'bg-white') }, void 0),
                _jsx("span", __assign({ className: dropdown
