...
var Playground = (function (_super) {
    ...
    function Playground() {
        ...
        _this.checkboxPropsHandler = function (key, props, children) {
            var tempProps = children
            ...
            if (_this.state[key]) {
                ...
                for (var prop in props) {
                    tempProps[prop] = children ? '' : false;
                }
            }
            children
                ? _this.setState({ childrenProps: tempProps })
    ...
    Playground.prototype.componentDidMount = function () {
        ...
        if (this.props.config.defaultState.componentProps.onChange) {
            newCompProps.onChange = function (event) {
                return _this.props.config.defaultState.componentProps.onChange.call(_this, event);
            };
        }
        if (this.props.config.defaultState.componentProps.onDelete) {
            newCompProps.onDelete = function (event) {
                return _this.props.config.defaultState.componentProps.onDelete.call(_this, event);
            };
        }
        if (this.props.config.defaultState.componentProps.onClose) {
            newCompProps.onClose = function (event) {
                return _this.props.config.defaultState.componentProps.onClose.call(_this, event);
            };
        }
        if (this.props.config.defaultState.componentProps.toPage) {
            newCompProps.toPage = function (event) {
                return _this.props.config.defaultState.componentProps.toPage.call(_this, event);
            };
        }
        this.setState({ componentProps: newCompProps });
        var childrenProps = __assign({}, this.state.childrenProps);
        if (this.props.config.defaultState.childrenProps &&
            this.props.config.defaultState.childrenProps.onChange) {
            childrenProps.onTabChange = function (event) {
                return _this.props.config.defaultState.childrenProps.onChange.call(_this, event);
            };
        }
    ...
    Playground.prototype.render = function () {
                ...
                this_1.state.UIState[key].options.forEach(function (item) {
                    if (key === 'childrenProps') {
                        ...
                        checkboxModifiers.push({
                            name: item.name,
                            change: function () {
                                return _this.changeCheckboxHandler(item.name, item.properties, false);
                            },
                        });
                    }
                });
        ...
        return (_jsxs("div", __assign({ className: "w-full" }, { children: [_jsxs("div", __assign({ className: " flex space-around h-128" }, { children: [_jsxs("div", __assign({ className: "flex-1 bg-medium-light-gray-100" }, { children: [controlsAbove.length > 0 && (_jsx("div", __assign({ className: "playground-header flex justify-around items-center border-b-2 border-medium-light-gray-200" }, { children: controlsAbove.map(function (control) {
                                ...
                                _jsx("div", __assign({ className: "playground-main " + (controlsAbove.length > 0 ? 'with-header' : '') + " flex items-center justify-center p-24  " + (this.state.background === 'dark'
                                        ...
                                        : 'bg-medium-light-gray-100') }, { children: this.state.UIState.form ? (_jsxs(Form, __assign({ className: "w-full flex justify-center", dark: this.state.componentProps.dark, onSubmit: function () {
                                            return null;
                                        } }, { children: [' ', childrenEl, ' '] }), void 0)) : (_jsxs("div", __assign({ className: "flex justify-center w-full" }, { children: [this.state.UIState.trigger && (_jsx(Button, __assign({ size: "large", variant: "primary", onClick: this.state.UIState.triggerFn }, { children: this.state.UIState.triggerText }), void 0)), childrenEl] }), void 0)) }), void 0)] }), void 0),
                        checkboxModifiers.length ||
                            ...
                            childrenControls.length ? (_jsxs(Form, __assign({ preview: true, dark: true, className: "overflow-y-auto w-1/4", onSubmit: function () {
                                ...
                                childrenControls.length > 0 && (_jsx(FormGroup, __assign({ preview: true, legend: "children props" }, { children: childrenControls.map(function (control) {
                ...
                _jsx(CodeSnippet, __assign({ flush: "top" }, { children: childrenEl.map(function (el) {
                        return reactElementToJSXString(el, {
                            ...
                            showFunctions: true,
                            functionValue: function () { return '() => {}'; },
                        })
                            .replace('onChange={undefined}', '')
                            .replace('onDelete={undefined}', '')
                            .replace('onClose={undefined}', '');
                    }) }), void 0)] }), void 0));
    };
    return Playground;
}(Component));
