...
var Card = function (_a) {
    ...
    return (_jsxs("div", __assign({ className: "rounded-md shadow-0-3-6-dark-gray-1 " + (dark ? 'bg-light-gray' : 'bg-white') + " " + className }, otherProps, { children: [image && _jsx("img", { src: image, alt: alt, className: "w-full max-h-48 rounded-md" }, void 0),
            _jsxs("div", __assign({ className: "p-8" }, { children: [icon && _jsx(IconCustom, { icon: icon, className: "text-blue h-12 mb-4" }, void 0),
                    _jsx("p", __assign({ className: "font-title text-xl text-dark-gray tracking-smallest" }, { children: title }), void 0),
                    _jsx(Divider, { className: "my-4" }, void 0),
                    _jsx("p", __assign({ className: "text-medium-dark-gray font-body text-base text-left tracking-normal" }, { children: children }), void 0)] }), void 0)] }), void 0));
};
export default Card;
