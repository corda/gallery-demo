...
var Button = function (_a) {
    var size = _a.size, variant = _a.variant, _b = _a.className, className = _b === void 0 ? '' : _b, dark = _a.dark, disabled = _a.disabled, iconLeft = _a.iconLeft, iconRight = _a.iconRight, isLink = _a.isLink, rel = _a.rel, noPaddingFocus = _a.noPaddingFocus, target = _a.target, to = _a.to, children = _a.children, otherProps = __rest(_a, ["size", "variant", "className", "dark", "disabled", "iconLeft", "iconRight", "isLink", "rel", "noPaddingFocus", "target", "to", "children"]);
    ...
    var button = (_jsxs("button", __assign({ className: defineClasses() + " " + className, disabled: disabled }, otherProps, { children: [iconLeft && _jsx(IconCustom, { icon: iconLeft, className: "h-4 mr-3 -ml-3" }, void 0),
            _jsx("span", __assign({ className: !disabled ? "relative button-" + variant + "-text" : '' }, { children: children }), void 0),
            iconRight && _jsx(IconCustom, { icon: iconRight, className: "h-4 -mr-3 ml-3" }, void 0)] }), void 0));
