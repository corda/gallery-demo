...
var DashboardItem = function (_a) {
    var alt = _a.alt, icon = _a.icon, image = _a.image, _b = _a.className, className = _b === void 0 ? '' : _b, withBackground = _a.withBackground, children = _a.children;
    return (_jsxs("div", __assign({ className: className + " w-full items-center h-full flex flex-col justify-center p-6 " + (withBackground ? 'bg-light-gray rounded-md' : '') }, { children: [image ? (_jsx("img", { src: image, alt: alt || '', height: "72px", width: "72px", className: "self-center pb-4" }, void 0)) : (_jsx(Pictogram, { icon: icon, className: "pb-4" }, void 0)),
            _jsx("span", __assign({ className: "text-xs text-dark-gray-300 uppercase tracking-large text-center font-bold" }, { children: children }), void 0)] }), void 0));
};
