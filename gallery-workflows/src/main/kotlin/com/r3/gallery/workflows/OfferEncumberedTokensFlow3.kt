...
@InitiatingFlow
@StartableByRPC
class OfferEncumberedTokensFlow3(
...
/**
 * Responder flow for [OfferEncumberedTokensFlow3].
 * Finalise push token transaction.
 */
@InitiatedBy(OfferEncumberedTokensFlow3::class)
class OfferEncumberedTokensFlow3Handler(val otherSession: FlowSession) : FlowLogic<Unit>() {
    @Suspendable
    override fun call() {
